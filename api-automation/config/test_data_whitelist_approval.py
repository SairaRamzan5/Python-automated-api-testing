...
WHITELIST_APPROVAL_TEST_CASES = [
    ...
    {
        "test_id": "TC_Whitelist_Approve_06",
        "description": "Approve without reason (reason is optional)",
        "data": {
            "user_id": "{user_id}",
            "status": "approved"
            # Reason field omitted - should be accepted
        },
        "expected_status": 200,
        "expected_success": True,
        "expected_message": "Whitelist audit created successfully",
    ...
    {
        "test_id": "TC_Whitelist_Approve_07",
        "description": "Approve with empty reason string",
        "data": {
            "user_id": "{user_id}",
            "status": "approved",
    ...
    {
        "test_id": "TC_Whitelist_Approve_09",
        "description": "Approve with very long reason (exceeds limit)",
        "data": {
            "user_id": "{user_id}",
            "status": "approved",
            "reason": "A" * 300  # Exceeds 255 character limit
        },
        "expected_status": 422,
        "expected_success": False,
        "expected_message": "Validation failed",
    ...
    {
        "test_id": "TC_Whitelist_Approve_10",
        "description": "Approve with minimum length reason",
        "data": {
            "user_id": "{user_id}",
            "status": "approved",
            "reason": "a"  # Single character - should be accepted
        },
        "expected_status": 200,
        "expected_success": True,
        "expected_message": "Whitelist audit created successfully",
    ...
    {
        "test_id": "TC_Whitelist_Approve_12",
        "description": "Reject an already approved user",
        "data": {
            "user_id": "{approved_user_id}",
            "status": "rejected",
    ...
    {
        "test_id": "TC_Whitelist_Approve_13",
        "description": "Approve a previously rejected user",
        "data": {
            "user_id": "{rejected_user_id}",
            "status": "approved",
    ...
    {
        "test_id": "TC_Whitelist_Approve_14",
        "description": "Reject with minimum reason",
        "data": {
            "user_id": "{user_id}",
            "status": "rejected",
            "reason": "X"  # Single character reason for rejection
        },
        "expected_status": 200,
        "expected_success": True,
        "expected_message": "Whitelist audit created successfully",
